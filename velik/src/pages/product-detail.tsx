...
import { useGetProduct, useGetRelatedProducts, useAddCartItem, useListReviews, useCreateReview, getListReviewsQueryKey } from "@/api";
...
import { getGetProductQueryKey } from "@/api";
